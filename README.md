...
For a single run, from the main folder use (in case for example tau=25 min):
...
To run the parameter sweep, from the main folder use (in case for example tau=25 min)
